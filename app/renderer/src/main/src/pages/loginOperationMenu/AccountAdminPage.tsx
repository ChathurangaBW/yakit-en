        ...
        <YakitSpin spinning={loading}>
          ...
          <YakitTree
            ...
            titleRender={(nodeData) => {
              const { isShowAllBtn = true, isShowAddBtn, title, userNum, key, pid } = nodeData as DataSourceProps
              return (
                <div
                          ...
                          <YakitInput
                            ...
                            onBlur={(e) => {
                              if (!!e.target.value.length) {
                                ...
                                yakitNotify('warning', t('OrganizationAdmin.cannotBeEmpty'))
                              }
                            }}
                          ></YakitInput>
                        }
                                ...
                                <CreateOrganizationForm
                                  ...
                                  refresh={() => {
                                    onLoadData({ key: key }).then(() => {
                                      ...
                                      setExpandedKeys((prev) => [...new Set(prev.concat(key))])
                                    })
                                  }}
                                  parentId={key}
                                />
