    ...
    >
      <div className={classNames(styles['memory-left-side'], { [styles['memory-left-side-hidden']]: !show })}>
        ...
        <YakitCollapse defaultActiveKey={['ratingRange', 'Tags']} className={styles['memory-query-collapse']}>
          ...
          >
            <div className={styles['select-rate-mode']}>
              <div className={styles['select-all']}>
                <YakitCheckbox checked={selectAllRate} indeterminate={indeterminate} onChange={onSelectAllRate} />
                全选
              </div>
            ...
            {ratingList.map((item) => {
              ...
              return (
                <div key={item.id} className={styles['rating-item']}>
                  <YakitCheckbox checked={checked} onChange={(e) => onSelectRate(item, e.target.checked)} />
          ...
          <YakitPanel
            header={<div className={styles['panel-header']}>Tags{tagsLoading && <LoadingOutlined spin />}</div>}
            key="Tags"
            extra={
              <>
                <YakitRadioButtons
            ...
            <div className={styles['tag-list']}>
              {tags.map((tagItem) => {
                ...
                return (
                  ...
                  >
                    <div className={styles['tag-label-wrapper']} onClick={() => onnSelectTag(tagItem, !checked)}>
