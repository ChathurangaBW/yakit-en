...
export const TitleColor = [
  ...
  { key: ['low'], value: 'title-low', name: 'Low', img: lowImg, tag: 'title-background-low' },
  {
  ...
  { key: ['high'], value: 'title-high', name: 'High', img: highImg, tag: 'title-background-high' },
  {
          ...
          {typekind.map((ele) => {
            ...
            return (
              <div className="title-selected-tag" key={type}>
                ...
                <div className="tag-del-style" onClick={() => filterSelect('type', ele.Names.join(','))}>
                  x
                </div>
              </div>
            )
          ...
          {severitykind?.map((ele) => {
            ...
            return (
              <div className="title-selected-tag" key={severity}>
                ...
                <div className="tag-del-style" onClick={() => filterSelect('severity', ele.Names.join(','))}>
                  x
                </div>
              </div>
            )
        ...
        <Table<Risk>
          ...
          onRow={(record) => {
            return {
              onContextMenu: (event) => {
                showByContextMenu({
                  data: [{ key: 'delect-repeat', title: 'Delete duplicate title data' }],
                  onClick: ({ key }) => {
...
export const RiskDetails: React.FC<RiskDetailsProp> = React.memo((props: RiskDetailsProp) => {
  ...
  return (
            ...
            <div className="header-subtitle">
              ...
              {isShowTime && (
                <div className="subtitle-spacing">
                  发现时间
                  <span className="subtitle-font">{info.CreatedAt > 0 ? formatTimestamp(info.CreatedAt) : '-'}</span>
                </div>
              )}
              {isShowTime && (
                <div>
    ...
    >
      ...
      <Descriptions.Item label="Reverse Token">
      ...
      {!shrink && (
        <>
          <Descriptions.Item label="Vulnerability Description" span={3}>
